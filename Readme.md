...
Предоставляет врачу опросник по состоянию пострадавшего ("есть кровотечение?", "частота сердечных сокращений более 20 в минуту?"). По опроснику формируется битовая маска статуса пострадавшего. Данные отправляются серверу.
...
**3. Backend сервер**
Реализует логику приоретизации пострадавших по операционным.  Оценивает время ожидания.
...
*Возможные улучшения: хранение статичтсических данных*
